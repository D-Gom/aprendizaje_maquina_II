...
user= 'postgres'
password= 'gy.ku9*T61?{x?(0'
netloc='34.176.121.118'
port='5432'
dbname='postgres'
...
#normal logging
log_model(LogisticRegressionCV      ,'diego', experiment_id = new_experiment_id, **{'class_weight':'balanced'})
log_model(RandomForestClassifier    ,'diego', experiment_id = new_experiment_id, **{'class_weight':'balanced'})
log_model(GradientBoostingClassifier,'diego', experiment_id = new_experiment_id, **{'learning_rate':0.1})
log_model(AdaBoostClassifier,'diego', experiment_id = new_experiment_id, **{'learning_rate':0.1,'n_estimators':50})
log_model(LinearSVC,'diego', experiment_id = new_experiment_id, **{'random_state':0,'tol':1e-05})
